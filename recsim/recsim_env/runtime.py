...
class TFRuntime(runtime.Runtime):
  ...
  def __init__(self, network, graph_compile = True):
    ...
    def execute_fn(
      ...
      # print(self._network.invariants())
    ...
    self._sub_trajectory_fn = (
        tf.function(sub_trajectory_fn) if graph_compile else sub_trajectory_fn)
  ...
  def execute(self,
    ...
    """
    return self._unpack(self._execute_fn(num_steps, starting_value, est))
  ...
  def sub_trajectory(
    ...
    Returns:
      ...
      `NetworkTrajectory`.
    """
    return self._unpack(self._sub_trajectory_fn(length, starting_value))
  ...
  def _pack(self, network_value):
    ...
    # print(network_value)
    # lst=[]
    # for var in self._network.variables:
    #   print(var.name)
    #   lst.append(network_value[var.name].as_dict)
    # return lst
