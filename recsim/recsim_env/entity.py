...
def _get_entities_and_model(story):
  ...
  with ed.trace(tracer):
    sim_vars, phi, mu, actor, critic = story()
  return sim_vars, entity_handles, phi, mu, actor, critic


def story_with_trainable_variables_and_model(
    story):
  ...
  Returns:
    ...
    variables.
  """
  sim_vars, entities, phi, mu, actor, critic = _get_entities_and_model(story)
  return sim_vars, {
